...
public class InputContacts {
    ...
    private final String INPUT_PATTERN_XPATH_ON_CONTACTS_PAGE = "//*[contains(text(), '%s')]/ancestor::" +
            "div[@class='tab-content']//parent::div//input[@id='%s']";
    ...
    public String getTextOnContractsPage() {
        log.info("Get text from a populated 'Input' field with a parameter '{}' and '{}'", label, id);
